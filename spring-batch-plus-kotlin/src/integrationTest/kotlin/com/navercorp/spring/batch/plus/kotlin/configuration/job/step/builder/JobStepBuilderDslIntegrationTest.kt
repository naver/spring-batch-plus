...
/**
 * Covers the integration boundary from nested job declarations to actual job-step execution.
 */
internal class JobStepBuilderDslIntegrationTest {
    @Test
    fun jobBeanShouldCreateJobStepWhenBeanNameIsProvided() {
        // given
    ...
    @Test
    fun jobBeanShouldCreateJobStepWhenBeanNameAndInitAreProvided() {
        // given
        val context = AnnotationConfigApplicationContext(TestConfiguration::class.java)
        val jobOperator = context.getBean<JobOperator>()
        val batch = context.getBean<BatchDsl>()
    ...
    @Test
    fun jobShouldCreateJobStepWhenJobIsProvided() {
        // given
        val context = AnnotationConfigApplicationContext(TestConfiguration::class.java)
        val jobOperator = context.getBean<JobOperator>()
        val batch = context.getBean<BatchDsl>()
    ...
    @Test
    fun jobShouldCreateJobStepWhenJobAndInitAreProvided() {
        // given
        val context = AnnotationConfigApplicationContext(TestConfiguration::class.java)
        val jobOperator = context.getBean<JobOperator>()
        val batch = context.getBean<BatchDsl>()
