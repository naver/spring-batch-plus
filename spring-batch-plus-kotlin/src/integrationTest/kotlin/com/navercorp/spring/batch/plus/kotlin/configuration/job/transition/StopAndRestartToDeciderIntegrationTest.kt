...
/**
 * Covers a decider as the restart target after a stopped execution.
 */
internal class StopAndRestartToDeciderIntegrationTest {
    @Test
    fun stopAndRestartToDeciderBeanShouldRestartAtDeciderWhenBeanNameIsProvided() {
        // given
    ...
    @Test
    fun stopAndRestartToDeciderShouldRestartAtDeciderWhenInstanceIsProvided() {
        // given
        val context = AnnotationConfigApplicationContext(TestConfiguration::class.java)
        val jobOperator = context.getBean<JobOperator>()
        val batch = context.getBean<BatchDsl>()
