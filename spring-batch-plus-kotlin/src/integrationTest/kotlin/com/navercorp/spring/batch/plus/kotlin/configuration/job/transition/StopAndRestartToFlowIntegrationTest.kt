...
/**
 * Covers a flow as the restart target after a stopped execution.
 */
internal class StopAndRestartToFlowIntegrationTest {
    @Test
    fun stopAndRestartToFlowBeanShouldRestartAtFlowWhenBeanNameIsProvided() {
        // given
    ...
    @Test
    fun stopAndRestartToFlowShouldRestartAtFlowWhenInitIsProvided() {
        // given
        val context = AnnotationConfigApplicationContext(TestConfiguration::class.java)
        val jobOperator = context.getBean<JobOperator>()
        val batch = context.getBean<BatchDsl>()
    ...
    @Test
    fun stopAndRestartToFlowShouldRestartAtFlowWhenInstanceIsProvided() {
        // given
        val context = AnnotationConfigApplicationContext(TestConfiguration::class.java)
        val jobOperator = context.getBean<JobOperator>()
        val batch = context.getBean<BatchDsl>()
    ...
    @Test
    fun stopAndRestartToFlowBeanShouldApplySubsequentTransitionAfterRestartWhenBeanNameAndTransitionAreProvided() {
        // given
        val context = AnnotationConfigApplicationContext(TestConfiguration::class.java)
        val jobOperator = context.getBean<JobOperator>()
        val batch = context.getBean<BatchDsl>()
    ...
    @Test
    fun stopAndRestartToFlowShouldApplySubsequentTransitionAfterRestartWhenInitAndTransitionAreProvided() {
        // given
        val context = AnnotationConfigApplicationContext(TestConfiguration::class.java)
        val jobOperator = context.getBean<JobOperator>()
        val batch = context.getBean<BatchDsl>()
    ...
    @Test
    fun stopAndRestartToFlowShouldApplySubsequentTransitionAfterRestartWhenInstanceAndTransitionAreProvided() {
        // given
        val context = AnnotationConfigApplicationContext(TestConfiguration::class.java)
        val jobOperator = context.getBean<JobOperator>()
        val batch = context.getBean<BatchDsl>()
