...
/**
 * Covers step declarations that keep job construction on the sequential simple-job path.
 */
internal class JobBuilderDslSequentialStepCreationIntegrationTest {
    @Test
    ...
    @Test
    fun stepsShouldExecuteSequentiallyWhenTransitionsAreNotProvided() {
        // given
        val context = AnnotationConfigApplicationContext(TestConfiguration::class.java)
