...
/**
 * Covers a flow as an immediate transition destination, distinct from branching from a flow source.
 */
internal class OnFlowTargetIntegrationTest {
    @Test
    ...
    @Test
    fun flowShouldExecuteAsTransitionTargetWhenInitIsProvided() {
        // given
        val context = AnnotationConfigApplicationContext(TestConfiguration::class.java)
        val jobOperator = context.getBean<JobOperator>()
        val batch = context.getBean<BatchDsl>()
    ...
    @Test
    fun flowShouldExecuteAsTransitionTargetWhenInstanceIsProvided() {
        // given
        val context = AnnotationConfigApplicationContext(TestConfiguration::class.java)
        val jobOperator = context.getBean<JobOperator>()
        val batch = context.getBean<BatchDsl>()
    ...
    @Test
    fun flowBeanShouldApplySubsequentTransitionWhenBeanNameAndTransitionAreProvided() {
        // given
        val context = AnnotationConfigApplicationContext(TestConfiguration::class.java)
        val jobOperator = context.getBean<JobOperator>()
        val batch = context.getBean<BatchDsl>()
    ...
    @Test
    fun flowShouldApplySubsequentTransitionWhenInitAndTransitionAreProvided() {
        // given
        val context = AnnotationConfigApplicationContext(TestConfiguration::class.java)
        val jobOperator = context.getBean<JobOperator>()
        val batch = context.getBean<BatchDsl>()
    ...
    @Test
    fun flowShouldApplySubsequentTransitionWhenInstanceAndTransitionAreProvided() {
        // given
        val context = AnnotationConfigApplicationContext(TestConfiguration::class.java)
        val jobOperator = context.getBean<JobOperator>()
        val batch = context.getBean<BatchDsl>()
