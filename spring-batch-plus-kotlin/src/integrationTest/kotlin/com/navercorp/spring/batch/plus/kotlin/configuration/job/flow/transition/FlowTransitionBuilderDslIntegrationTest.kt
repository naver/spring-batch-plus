...
package com.navercorp.spring.batch.plus.kotlin.configuration.job.flow.transition
...
internal class FlowTransitionBuilderDslIntegrationTest {
    @RepeatedTest(10)
    fun flowShouldFollowMatchingTransitionWhenMultipleTransitionsAreConfigured() {
        // given
    ...
    @Test
    fun flowShouldThrowExceptionWhenTransitionBlockIsEmpty() {
        // given
        val context = AnnotationConfigApplicationContext(TestConfiguration::class.java)
        val batch = context.getBean<BatchDsl>()
        val testFlow1 =
