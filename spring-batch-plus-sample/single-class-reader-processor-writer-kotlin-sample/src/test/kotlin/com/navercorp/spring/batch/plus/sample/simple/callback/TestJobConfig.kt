...
package com.navercorp.spring.batch.plus.sample.simple.callback
...
open class TestJobConfig(
    ...
    @Bean
    open fun testJob(sampleTasklet: com.navercorp.spring.batch.plus.sample.simple.callback.SampleTasklet): Job =
        batch {
            job("testJob") {
                step("testStep") {
