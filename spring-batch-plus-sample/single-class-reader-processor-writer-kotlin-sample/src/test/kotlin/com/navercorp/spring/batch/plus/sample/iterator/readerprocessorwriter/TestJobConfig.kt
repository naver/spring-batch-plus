...
package com.navercorp.spring.batch.plus.sample.iterator.readerprocessorwriter
...
open class TestJobConfig(
    ...
    @Bean
    open fun testJob(sampleTasklet: com.navercorp.spring.batch.plus.sample.iterator.readerprocessorwriter.SampleTasklet): Job =
        batch {
            job("testJob") {
                step("testStep") {
