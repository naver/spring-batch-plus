...
package com.navercorp.spring.batch.plus.sample.iterator.readerwriter
...
open class TestJobConfig(
    ...
    @Bean
    open fun testJob(sampleTasklet: com.navercorp.spring.batch.plus.sample.iterator.readerwriter.SampleTasklet): Job =
        batch {
            job("testJob") {
                step("testStep") {
