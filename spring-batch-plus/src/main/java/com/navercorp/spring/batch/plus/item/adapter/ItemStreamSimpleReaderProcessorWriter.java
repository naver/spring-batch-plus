 ...
 * @since 1.1.0
 */
public interface ItemStreamSimpleReaderProcessorWriter<I, O>
	extends ItemStreamSimpleReaderDelegate<I>, ItemProcessorDelegate<I, O>, ItemStreamWriterDelegate<O> {
}
