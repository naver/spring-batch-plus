...
class ItemStreamSimpleReaderProcessorIntegrationTest {
	...
	private static final Logger logger = LoggerFactory.getLogger(
		ItemStreamSimpleReaderProcessorIntegrationTest.class);
	...
	void testReaderProcessor() throws Exception {
		...
		ItemStreamSimpleReaderProcessor<Integer, Integer> testTasklet = context.getBean(
			"testTasklet",
	...
	static class TestConfiguration {
		...
		@Bean
		ItemStreamSimpleReaderProcessor<Integer, Integer> testTasklet() {
			return new ItemStreamSimpleReaderProcessor<>() {
		...
		@Bean
		@StepScope
		ItemStreamSimpleReaderProcessor<Integer, Integer> stepScopeTestTasklet() {
			return new ItemStreamSimpleReaderProcessor<>() {
