...
class ItemStreamIteratorReaderProcessorWriterIntegrationTest {

	private static final int TEST_REPEAT_COUNT = 5;

	private static final Logger logger = LoggerFactory.getLogger(
		ItemStreamIteratorReaderProcessorWriterIntegrationTest.class);
	...
	void testReaderProcessorWriter() throws Exception {
		...
		ItemStreamIteratorReaderProcessorWriter<Integer, Integer> testTasklet = context.getBean(
			"testTasklet",
			ItemStreamIteratorReaderProcessorWriter.class);
	...
	@RepeatedTest(TEST_REPEAT_COUNT)
	void testReaderProcessorWriterWithSameTaskletShouldKeepContext() throws Exception {
		// given
		AnnotationConfigApplicationContext context = new AnnotationConfigApplicationContext(TestConfiguration.class);
		JobRepository jobRepository = context.getBean(JobRepository.class);
		ItemStreamIteratorReaderProcessorWriter<Integer, Integer> testTasklet = context.getBean(
	...
	@RepeatedTest(TEST_REPEAT_COUNT)
	void testStepScopeReaderProcessorWriterWithSameTaskletShouldNotKeepCountContext() throws Exception {
		// given
		AnnotationConfigApplicationContext context = new AnnotationConfigApplicationContext(TestConfiguration.class);
		JobRepository jobRepository = context.getBean(JobRepository.class);
		ItemStreamIteratorReaderProcessorWriter<Integer, Integer> testTasklet = context.getBean(
	...
	static class TestConfiguration {
		...
		@Bean
		ItemStreamIteratorReaderProcessorWriter<Integer, Integer> testTasklet() {
			return new ItemStreamIteratorReaderProcessorWriter<>() {
		...
		@Bean
		@StepScope
		ItemStreamIteratorReaderProcessorWriter<Integer, Integer> stepScopeTestTasklet() {
			return new ItemStreamIteratorReaderProcessorWriter<>() {
