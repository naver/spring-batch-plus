...
class ItemStreamSimpleReaderProcessorWriterIntegrationTest {
	...
	private static final Logger logger = LoggerFactory.getLogger(
		ItemStreamSimpleReaderProcessorWriterIntegrationTest.class);
	...
	void testReaderProcessorWriter() throws Exception {
		...
		ItemStreamSimpleReaderProcessorWriter<Integer, Integer> testTasklet = context.getBean(
			"testTasklet",
			ItemStreamSimpleReaderProcessorWriter.class);
	...
	static class TestConfiguration {
		...
		@Bean
		ItemStreamSimpleReaderProcessorWriter<Integer, Integer> testTasklet() {
			return new ItemStreamSimpleReaderProcessorWriter<>() {
		...
		@Bean
		@StepScope
		ItemStreamSimpleReaderProcessorWriter<Integer, Integer> stepScopeTestTasklet() {
			return new ItemStreamSimpleReaderProcessorWriter<>() {
