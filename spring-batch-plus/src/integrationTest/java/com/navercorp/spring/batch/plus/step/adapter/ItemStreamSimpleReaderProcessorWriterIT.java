...
class ItemStreamSimpleReaderProcessorWriterIT {
	...
	void simpleReaderProcessorWriterShouldNotKeepCountWhenStepScoped() throws Exception {
		...
		context.refresh();
		ItemStreamSimpleReaderProcessorWriter<Integer, Integer> testTasklet = context.getBean("testTasklet",
	...
	private static class TestTasklet implements ItemStreamSimpleReaderProcessorWriter<Integer, Integer> {
