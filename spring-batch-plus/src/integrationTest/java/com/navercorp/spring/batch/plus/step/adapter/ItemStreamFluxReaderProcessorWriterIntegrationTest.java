...
class ItemStreamFluxReaderProcessorWriterIntegrationTest {
	...
	private static final Logger logger = LoggerFactory.getLogger(
		ItemStreamFluxReaderProcessorWriterIntegrationTest.class);
	...
	void testReaderProcessorWriter() throws Exception {
		...
		ItemStreamFluxReaderProcessorWriter<Integer, Integer> testTasklet = context.getBean(
			"testTasklet",
	...
	static class TestConfiguration {
		...
		@Bean
		ItemStreamFluxReaderProcessorWriter<Integer, Integer> testTasklet() {
			return new ItemStreamFluxReaderProcessorWriter<>() {
		...
		@Bean
		@StepScope
		ItemStreamFluxReaderProcessorWriter<Integer, Integer> stepScopeTestTasklet() {
			return new ItemStreamFluxReaderProcessorWriter<>() {
