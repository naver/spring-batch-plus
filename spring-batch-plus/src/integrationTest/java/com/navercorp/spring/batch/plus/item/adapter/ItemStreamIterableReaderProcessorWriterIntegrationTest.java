...
class ItemStreamIterableReaderProcessorWriterIntegrationTest {
	...
	private static final Logger logger = LoggerFactory.getLogger(
		ItemStreamIterableReaderProcessorWriterIntegrationTest.class);
	...
	void testReaderProcessorWriter() throws Exception {
		...
		ItemStreamIterableReaderProcessorWriter<Integer, Integer> testTasklet = context.getBean(
			"testTasklet",
	...
	static class TestConfiguration {
		...
		@Bean
		ItemStreamIterableReaderProcessorWriter<Integer, Integer> testTasklet() {
			return new ItemStreamIterableReaderProcessorWriter<>() {
		...
		@Bean
		@StepScope
		ItemStreamIterableReaderProcessorWriter<Integer, Integer> stepScopeTestTasklet() {
			return new ItemStreamIterableReaderProcessorWriter<>() {
