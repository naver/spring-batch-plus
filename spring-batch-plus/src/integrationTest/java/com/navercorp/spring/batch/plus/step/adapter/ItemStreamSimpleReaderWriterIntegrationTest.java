...
class ItemStreamSimpleReaderWriterIntegrationTest {

	private static final int TEST_REPEAT_COUNT = 5;

	private static final Logger logger = LoggerFactory.getLogger(ItemStreamSimpleReaderWriterIntegrationTest.class);
	...
	void testReaderWriter() throws Exception {
		...
		ItemStreamSimpleReaderWriter<Integer> testTasklet = context.getBean(
			"testTasklet",
	...
	static class TestConfiguration {
		...
		@Bean
		ItemStreamSimpleReaderWriter<Integer> testTasklet() {
			return new ItemStreamSimpleReaderWriter<>() {
		...
		@Bean
		@StepScope
		ItemStreamSimpleReaderWriter<Integer> stepScopeTestTasklet() {
			return new ItemStreamSimpleReaderWriter<>() {
