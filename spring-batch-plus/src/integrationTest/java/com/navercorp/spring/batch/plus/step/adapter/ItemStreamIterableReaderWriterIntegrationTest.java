...
class ItemStreamIterableReaderWriterIntegrationTest {

	private static final int TEST_REPEAT_COUNT = 5;

	private static final Logger logger = LoggerFactory.getLogger(ItemStreamIterableReaderWriterIntegrationTest.class);
	...
	void testReaderWriter() throws Exception {
		...
		ItemStreamIterableReaderWriter<Integer> testTasklet = context.getBean(
			"testTasklet",
	...
	static class TestConfiguration {
		...
		@Bean
		ItemStreamIterableReaderWriter<Integer> testTasklet() {
			return new ItemStreamIterableReaderWriter<>() {
		...
		@Bean
		@StepScope
		ItemStreamIterableReaderWriter<Integer> stepScopeTestTasklet() {
			return new ItemStreamIterableReaderWriter<>() {
