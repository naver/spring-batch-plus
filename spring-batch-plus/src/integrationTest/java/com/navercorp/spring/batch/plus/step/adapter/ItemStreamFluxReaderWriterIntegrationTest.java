...
class ItemStreamFluxReaderWriterIntegrationTest {
	...
	private static final Logger logger = LoggerFactory.getLogger(ItemStreamFluxReaderWriterIntegrationTest.class);
	...
	void testReaderWriter() throws Exception {
		...
		ItemStreamFluxReaderWriter<Integer> testTasklet = context.getBean(
			"testTasklet",
	...
	static class TestConfiguration {
		...
		@Bean
		ItemStreamFluxReaderWriter<Integer> testTasklet() {
			return new ItemStreamFluxReaderWriter<>() {
		...
		@Bean
		@StepScope
		ItemStreamFluxReaderWriter<Integer> stepScopeTestTasklet() {
			return new ItemStreamFluxReaderWriter<>() {
