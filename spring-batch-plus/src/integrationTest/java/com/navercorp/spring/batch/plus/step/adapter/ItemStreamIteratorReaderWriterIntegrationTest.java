...
class ItemStreamIteratorReaderWriterIntegrationTest {

	private static final int TEST_REPEAT_COUNT = 5;

	private static final Logger logger = LoggerFactory.getLogger(ItemStreamIteratorReaderWriterIntegrationTest.class);
	...
	void testReaderWriter() throws Exception {
		...
		ItemStreamIteratorReaderWriter<Integer> testTasklet = context.getBean(
			"testTasklet",
			ItemStreamIteratorReaderWriter.class);
	...
	static class TestConfiguration {
		...
		@Bean
		ItemStreamIteratorReaderWriter<Integer> testTasklet() {
			return new ItemStreamIteratorReaderWriter<>() {
		...
		@Bean
		@StepScope
		ItemStreamIteratorReaderWriter<Integer> stepScopeTestTasklet() {
			return new ItemStreamIteratorReaderWriter<>() {
