...
Kotlin DSL은 `JobBuilder`를 사용해서 `JobParameterIncrementer`를 설정하는 방법을 제공합니다. Kotlin의 Trailing Lambda를 활용하면 보다 간략하게 작성할 수 있습니다.
...
Kotlin DSL은 `JobBuilder`를 사용해서 `JobParametersValidator` 설정을 하는 방법을 제공합니다. Kotlin의 Trailing Lambda를 활용하면 보다 간략하게 작성할 수 있습니다.
